...
TopoDS_Edge FullCircle(const double radius)
{
  return FullCircle(ax2::OZ(), radius);
}

TopoDS_Edge FullCircle(const gp_Dir& direction, const double radius)
{
  return FullCircle(gp_Ax2(point::Origin(), direction), radius);
}

TopoDS_Edge FullCircle(const gp_Ax1& axis, const double radius)
{
  return FullCircle(ax2::FromAx1(axis), radius);
}

TopoDS_Edge FullCircle(const gp_Pnt& center, const gp_Dir& direction, const double radius)
{
  return FullCircle(gp_Ax1(center, direction), radius);
}

TopoDS_Edge FullCircle(const gp_Ax2& axis, const double radius)
{
...
TopoDS_Edge CircleSegment(const gp_Ax2& axis,
                          const double  radius,
                          const gp_Pnt& p1,
                          const gp_Pnt& p2)
{
  const gp_Circ circ(axis, radius);

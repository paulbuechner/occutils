...
gp_Vec operator*(const gp_Dir& a, const double factor)
{
...
gp_Dir X()
{
  return {gp_XYZ(1.0, 0.0, 0.0)};
}

gp_Dir Y()
{
  return {gp_XYZ(0.0, 1.0, 0.0)};
}

gp_Dir Z()
{
  return {gp_XYZ(0.0, 0.0, 1.0)};
}
